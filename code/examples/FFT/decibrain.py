...
class Decibrain():
    ...
    def __init__(self, datasize=2048,mic=None,debug=False,fname="../sounds/test.wav",frate=44100.0,dataQueue=None,brainQueue=None, output=False,threshold=17,stretch=4):
        ...
        print "detect music"
        self.detectMusic(datasize,mic,debug,fname,frate,dataQueue,brainQueue, output)

        pass


    def detectMusic(self,datasize=2048,mic=None,debug=False,fname="../sounds/test.wav",frate=44100.0,dataQueue=None, brainQueue=None,output=False):
...
if __name__ == '__main__':
    ...
    brain = Decibrain(datasize=data_size,mic=mic,debug=debug,fname=fname,frate=44100.0)
